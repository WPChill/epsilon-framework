...
export class EpsilonSectionDoubled {
  ...
  private handleEvents(): void {
     ...
     * Close sections
     */
    this.section.container.on( 'click', '.epsilon-close-doubled-section', function( e: Event ): void {
      e.preventDefault();
     ...
     * Open sections
     */
    this.section.headContainer.on( 'click', function( this: any, e: Event ): void {
      ...
      jQuery.each( this.section.container, function( this: any ): void {
